...
public class Response extends HashMap<String, Object> {
    ...
    private Response() {
        ...
        this.put(MESSAGE, ResponseEnum.SUCCESS.getMessage());
    }
    ...
    public Boolean isOK() {
        return this.getCode() == ResponseEnum.SUCCESS.getCode();
    }
...
//============状态===================================================================================
     ...
     * 传入ErrorEnum 枚举
     */
    public Response setError(ResponseEnum errorEnum) {
    ...
    public Response error(Throwable e) {
        ...
        //返回错误代码到前台
        this.setCode(ResponseEnum.SERVER_ERROR.getCode());
        this.put(MESSAGE, ResponseEnum.SERVER_ERROR.getMessage());
